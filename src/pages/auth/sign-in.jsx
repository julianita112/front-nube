...
export function SignIn() {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      const response = await axios.post("https://backend-delicrem-si.onrender.com/api/usuarios/login", {
        email,
        password,
      });
      ...
      if (response.status === 200) {
        ...
        const userResponse = await axios.get("https://backend-delicrem-si.onrender.com/api/usuarios", {
          headers: {
        ...
        try {
          const roleResponse = await axios.get(`https://backend-delicrem-si.onrender.com/api/roles/${user.id_rol}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
