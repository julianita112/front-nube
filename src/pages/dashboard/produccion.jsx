...
export function OrdenesProduccion() {
  ...
  const fetchOrdenes = async () => {
    try {
      const response = await axios.get("https://backend-delicrem-si.onrender.com/api/ordenesproduccion");
  ...
  const handleProducir = async (idOrden) => {
    try {
      await axios.post(`https://backend-delicrem-si.onrender.com/api/ordenesproduccion/${idOrden}/producir`);
      Toast.fire({
        icon: 'success',
  ...
  const toggleActivo = async (idOrden, currentStatus) => {
    try {
      await axios.patch(`https://backend-delicrem-si.onrender.com/api/ordenesproduccion/${idOrden}/activo`, {
