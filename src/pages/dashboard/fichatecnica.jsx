...
export function FichasTecnicas() {
  ...
  const fetchFichas = async () => {
    try {
      const response = await axios.get("https://backend-delicrem-si.onrender.com/api/fichastecnicas");
  ...
  const handleDelete = async (ficha) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backend-delicrem-si.onrender.com/api/fichastecnicas/${ficha.id_ficha}`);
        fetchFichas();
  ...
  const toggleActivo = async (id_ficha, activo) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.patch(`https://backend-delicrem-si.onrender.com/api/fichastecnicas/${id_ficha}/estado`, { activo: !activo });
        fetchFichas();
        Toast.fire({
          icon: 'success',
