...
export function Pedidos() {
  ...
  const handleUpdateEstado = async () => {
    try {
      const response = await axios.put(`https://backend-delicrem-si.onrender.com/api/pedidos/${selectedPedido.numero_pedido}/estado`, { estado: selectedEstado });
  ...
  const toggleActivo = async (id_pedido, activo) => {
    ...
    if (!activo) { // Si se está intentando activar el pedido
      try {
        await axios.patch(`https://backend-delicrem-si.onrender.com/api/pedidos/${id_pedido}/estado`, { activo: true });
        fetchPedidos();
        Swal.fire({
          icon: 'success',
  ...
  const handleCancelPedido = async () => {
    ...
    try {
      await axios.patch(`https://backend-delicrem-si.onrender.com/api/pedidos/${pedidoToCancel}/estado`, {
        activo: false,
