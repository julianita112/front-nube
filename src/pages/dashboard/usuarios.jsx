...
export function Usuarios() {
  ...
  const handleDelete = async (user) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backend-delicrem-si.onrender.com/api/usuarios/${user.id_usuario}`);
        fetchUsuarios();
        Toast.fire({
          icon: "success",
  ...
  const toggleActivo = async (id_usuario, activo) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        await axios.patch(`https://backend-delicrem-si.onrender.com/api/usuarios/${id_usuario}/estado`, { activo: !activo });
        fetchUsuarios();
        Toast.fire({
          icon: 'success',
