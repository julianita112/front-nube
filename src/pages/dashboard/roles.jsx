...
export function Roles() {
  ...
  const fetchRoles = async () => {
    try {
      const response = await axios.get("https://backend-delicrem-si.onrender.com/api/roles");
  ...
  const fetchPermisos = async () => {
    try {
      const response = await axios.get("https://backend-delicrem-si.onrender.com/api/permisos");
  ...
  const handleDelete = async (role) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backend-delicrem-si.onrender.com/api/roles/${role.id_rol}`);
  ...
  const handleSave = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(`https://backend-delicrem-si.onrender.com/api/roles/${selectedRole.id_rol}`, {
        ...
        await axios.post("https://backend-delicrem-si.onrender.com/api/roles", {
          nombre: selectedRole.nombre,
          permisos: selectedRole.permisosRol,
          activo: selectedRole.activo,
        });
    ...
    if (result.isConfirmed) {
      try {
        if (activo) { // Solo verificamos si intentamos desactivar el rol
          ...
          const response = await axios.get(`https://backend-delicrem-si.onrender.com/api/usuarios`);
        ...
        await axios.patch(`https://backend-delicrem-si.onrender.com/api/roles/${id_rol}/estado`, { activo: !activo });
        fetchRoles();
        Toast.fire({
          icon: 'success',
