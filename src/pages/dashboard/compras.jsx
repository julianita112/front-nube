...
export function Compras() {
  ...
  const fetchCompras = async () => {
    try {
      const response = await axios.get("https://backend-delicrem-si.onrender.com/api/compras");
  ...
  const toggleActivo = async (id_compra, activo) => {
    ...
    if (!activo) {
      try {
        await axios.patch(`https://backend-delicrem-si.onrender.com/api/compras/${id_compra}/estado`, { activo: true });
        fetchCompras();
        Toast.fire({
          icon: 'success',
  ...
  const handleCancelCompra = async () => {
    ...
    try {
      await axios.patch(`https://backend-delicrem-si.onrender.com/api/compras/${compraToCancel}/estado`, { 
        activo: false, 
