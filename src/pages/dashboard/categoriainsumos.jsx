...
export function CategoriaInsumos() {
  ...
  const fetchCategorias = async () => {
    try {
      const response = await axios.get("https://backend-delicrem-si.onrender.com/api/categorias_insumo");
  ...
  const handleDelete = async (categoria) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`https://backend-delicrem-si.onrender.com/api/categorias_insumo/${categoria.id_categoria}`);
        fetchCategorias();
  ...
  const handleSave = async () => {
    try {
      ...
      if (editMode) {
        await axios.put(`https://backend-delicrem-si.onrender.com/api/categorias_insumo/${selectedCategoria.id_categoria}`, selectedCategoria);
        setOpen(false);
        fetchCategorias();
        ...
        await axios.post("https://backend-delicrem-si.onrender.com/api/categorias_insumo", selectedCategoria);
        fetchCategorias();
        setOpen(false);
        const Toast = Swal.mixin({
          toast: true,
    ...
    if (result.isConfirmed) {
      try {
        if (categoria.activo) { // Solo verificamos si intentamos desactivar la categoría
          ...
          const response = await axios.get(`https://backend-delicrem-si.onrender.com/api/insumos?categoria_id=${categoria.id_categoria}`);
        ...
        await axios.patch(`https://backend-delicrem-si.onrender.com/api/categorias_insumo/${categoria.id_categoria}/estado`, { activo: !categoria.activo });
        fetchCategorias();
        Swal.fire({
          icon: 'success',
