...
const CrearUsuario = ({
  ...
  const handleSave = async () => {
    ...
    try {
      if (editMode) {
        await axios.put(
          `https://backend-delicrem-si.onrender.com/api/usuarios/${selectedUser.id_usuario}`,
          selectedUser
        );
        fetchUsuarios();
        Toast.fire({
        ...
        await axios.post("https://backend-delicrem-si.onrender.com/api/usuarios/registro", selectedUser);
        fetchUsuarios();
        Toast.fire({
          icon: "success",
